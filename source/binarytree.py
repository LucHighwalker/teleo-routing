...
class BinarySearchTree(object):
    ...
    def height(self):
        ...
        Best and worst case running time: best case O(1) if the tree is empty,
        otherwise O(n) as it has to traverse all nodes."""
    ...
    def contains(self, item):
        ...
        node = self._find_node_recursive((item, 0), self.root)
    ...
    def insert(self, item):
        ...
        if item[0] < parent.data[0]:
            # TODO: Create a new node and set the parent's left child
            if parent.left is not None:
                if parent.left.data[0] < item[0]:
                    new_node.left = parent.left
                elif parent.left.data[0] > item[0]:
                    new_node.right = parent.rleft
            parent.left = new_node
        # TODO: Check if the given item should be inserted right of parent node
        elif item[0] > parent.data[0]:
            # TODO: Create a new node and set the parent's left child
            if parent.right is not None:
                if parent.right.data[0] < item[0]:
                    new_node.left = parent.right
                elif parent.right.data[0] > item[0]:
    ...
    def _traverse_in_order_recursive(self, node, visit):
        ...
        Running time: O(n) because it has to traverse all nodes?
        Memory usage: O(n) because it has to create an array with all the data"""
